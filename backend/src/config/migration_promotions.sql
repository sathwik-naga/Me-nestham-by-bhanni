-- Migration: Promotions, Coupons, Gift Cards, Flash Sales, and Announcements Engine
...
CREATE TABLE IF NOT EXISTS public.coupons (
  ...
  free_product_id UUID NULL, -- REFERENCES public.products(id) set dynamically
...
-- 3. Create Coupon Failures Table (to track failed validation/usage attempts)
...
-- 9. Add columns to Cart and Orders tables
...
-- 10. Indexes for fast validation querying
...
-- 13. Recreate the atomic order transaction RPC function
