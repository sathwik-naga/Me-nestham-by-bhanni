...
export default function TrustBadges() {
  ...
  return (
    <div className="bg-brand-secondary border-y border-brand-border py-12 px-6 font-accent">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {badges.map((badge, idx) => (
          <div 
            key={idx} 
            className="flex items-start gap-4 p-4 rounded-2xl bg-brand-card border border-brand-border/60 hover:border-brand-primary hover:shadow-md transition-all duration-300"
          >
